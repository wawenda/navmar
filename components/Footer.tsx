        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-extrabold text-white">NAVMAR</h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/70">
              <li className="flex items-start gap-2">
                ...
                <div>
                  <a href="tel:+905056453119" className="hover:text-accent transition-colors">+90 (505) 645 31 19</a>
                  <p className="text-xs text-accent">WhatsApp</p>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 text-accent mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-white/10 bg-black/20">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/60">
            <p>&copy; {currentYear} NAVMAR {language === 'tr' ? 'Gemi Acenteliği' : 'Shipping Agency'}. {language === 'tr' ? 'Tüm hakları saklıdır' : 'All rights reserved'}.</p>
            <p className="text-xs">{language === 'tr' ? 'İskenderun & Mersin Limanları' : 'İskenderun & Mersin Ports'}</p>
          </div>
        </div>
      </div>
    </footer>
