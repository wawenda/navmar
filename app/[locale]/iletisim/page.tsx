...
export default function Iletisim() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-primary via-primary to-primary/90 text-white py-16 pt-32 md:pt-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            ...
            <div className="flex flex-col">
              ...
              <div className="space-y-3">
                {/* İletişim Bilgileri - Birleşik Kart */}
                  ...
                  <div className="mb-4 pb-4 border-b border-slate-200">
                    ...
                    <div className="space-y-2">
                      <a
                        ...
                        className="flex items-center gap-2.5 p-2 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors group"
                      >
                        <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                  ...
                  <div className="mb-4 pb-4 border-b border-slate-200">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-semibold text-primary text-sm break-all">info@navmaragency.com</p>
                        </div>
                      </a>
                      <a
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-semibold text-primary text-sm break-all">navmar@navmaragency.com</p>
                        </div>
                      </a>
                    </div>
                  </div>

                  {/* Adres ve Diğer Bilgiler - Yan Yana */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {/* Address */}
                    <div>
                      <h3 className="text-xs font-bold text-primary mb-2 uppercase tracking-wider flex items-center gap-2">
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="space-y-0.5 text-xs text-gray-700">
                        <p className="font-semibold text-primary">Mustafa Kemal {t('footer.district')}</p>
                        <p>İbrahim Karaoğlanoğlu Cd. No: 192/1</p>
                        <p>Amanos Rezidans</p>
                        <p>31200 İskenderun / Hatay</p>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          <a
                            ...
                            className="flex items-center gap-1 px-2 py-1.5 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:shadow-lg transition-all text-xs font-medium"
                          >
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-1 px-2 py-1.5 bg-[#25D366] text-white rounded-lg hover:shadow-lg transition-all text-xs font-medium"
                          >
                            <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-1 px-2 py-1.5 bg-[#0077B5] text-white rounded-lg hover:shadow-lg transition-all text-xs font-medium"
                          >
                            <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col">
              ...
              <div className="relative rounded-xl overflow-hidden shadow-lg border border-slate-200 h-[500px]">
                <iframe 
